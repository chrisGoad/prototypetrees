...
A simple test harness, with examples, can be seen over at [https://prototypejungle.org/coreExamples.html](https://prototypejungle.org/coreExamples.html). This test harness illustrates direct use of the open source code; ProtoPedia has additional capabilities.
Also, documentation can be found at the ProtoPedia site. Sections 4 - 10  in the [coding guide](https://prototypejungle.org/doc/code.html) cover the workings of prototype trees.
